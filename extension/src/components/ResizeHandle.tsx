...
export const ResizeHandle: React.FC<ResizeHandleProps> = ({ onResizeStart }) => {
	return (
		<div
			className="absolute top-0 left-0 w-6 h-6 cursor-nwse-resize hover:bg-primary/30 active:bg-primary/40 rounded-tl-lg rounded-br-lg transition-all duration-150 z-10"
