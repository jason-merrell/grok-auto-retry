...
/**
 * State representing video mute status.
 * 
 * @property isMuted - Current mute state of active video
 * @property isAvailable - Whether mute controls are available (video exists)
 */
interface MuteState {
    isMuted: boolean;
    isAvailable: boolean;
